...
- **Primary sheets:** Antimony, Bismuth, Diamond (industrial), Gallium,
  Germanium, Graphite (natural), Indium, Lithium, Molybdenum, Rare Earths
  (grouped), Scandium, Tellurium, Tungsten, Abrasives (manufactured).
- **Derived views:** Diamond powders, Gallium nitride, Graphite anodes,
  Lithium batteries, Superhard materials, plus per-element rare-earth oxide
  prices for Europium / Gadolinium / Samarium. Other heavy REEs (Dysprosium,
  Erbium, Holmium, Lutetium, Terbium, Thulium, Ytterbium, Yttrium) appear
  as rows with "Not available" where MCS 2026 doesn't separately price them.
